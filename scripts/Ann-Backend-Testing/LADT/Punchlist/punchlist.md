...
- **PL-031** — Adding a new LADT entity doesn't scroll the sibling table to it (highlighted but off-screen).
- **PL-032** — Can't self-roster onto a team with no club; LADT gives no way to assign a club to a House Team.
