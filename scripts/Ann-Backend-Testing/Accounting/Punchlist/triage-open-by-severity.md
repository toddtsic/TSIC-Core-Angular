...
- [ ] **PL-009** — Family Players Breakdown column order should be Total Fee, Proc Fee, Paid, Owes

---

## Closed since the last triage
...
| PL-005 | UX | Fixed | Dollar-amount codes now step by $1; percent fields unchanged |

Also already closed in the punchlist but still listed as open in the prior
version of this file: **PL-018**, **PL-014**, **PL-010**, **PL-008**.
