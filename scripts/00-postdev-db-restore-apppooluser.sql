-- =============================================================================
-- Post-restore: re-create local IIS app pool db user in TSICV5
-- =============================================================================
...
--
-- Scope: this dev box has one IIS API pool: dev-api. The prod equivalent
-- (claude-api) is handled by IIS-Config-Prod/Deployment/Fix-IIS-DbLogin.sql.
--
-- Symptom if skipped:
...
PRINT 'Granted EXECUTE (db-wide) to dev-api app pool user.';
GO
