...
#
# Usage:
#   .\07-Apply-Secrets.ps1 -Environment Dev
#   .\07-Apply-Secrets.ps1 -Environment Dev -SecretsFile "C:\path\to\secrets.local.ps1"
#
...
Write-Host ""
Write-Host "[Step 7] Applying app pool environment variables ($Environment)..." -ForegroundColor Green
