# ============================================================================
# 03-Deploy-To-IIS.ps1 — Deploy built API + Angular to local IIS (Dev)
# ============================================================================
# Stops IIS sites, copies build outputs, starts IIS sites, fixes DB login,
# and warms up the API.
#
# Prerequisites: Run 01-Build-DotNet-API.ps1 and 02-Build-Angular.ps1 first.
#
# Usage:
#   .\03-Deploy-To-IIS.ps1
#   .\03-Deploy-To-IIS.ps1 -SkipBuild
# ============================================================================
...
Write-Host "TSIC Deploy to IIS (Dev)" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
try {
    ...
    $logPath = Join-Path $logDir ("deploy-Dev-" + (Get-Date -Format "yyyyMMdd-HHmmss") + ".log")
...
if (-not $SkipBuild) {
    ...
    Write-Host "Step 1b: Building Angular..." -ForegroundColor Yellow
    & "$PSScriptRoot\02-Build-Angular.ps1"
...
# ── Done ─────────────────────────────────────────────────────────────
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "SUCCESS! Deployed to Dev." -ForegroundColor Green
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
