# ============================================================================
# 02-Build-Angular.ps1 — Build Angular frontend (Dev)
# ============================================================================
...
Write-Host "Building TSIC Angular Application (Dev)..." -ForegroundColor Green
...
if (Test-Path $OutputPath) {
    ...
    if ($fileCount -gt 0) {
        ...
        $projectFolder = Join-Path $tempStaging "claude-app"
