...
- [001 — Environment / config drift](001-env-config-drift.md) — prod referenced dev endpoints once; could the reverse happen and hit real money / real customers from a dev or staging deploy?
