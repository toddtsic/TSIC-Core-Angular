...
export class TeamRegistrationService {
     ...
     */
    getTeamsMetadata(
        bPayBalanceDue: boolean = false,
    ): Observable<TeamsMetadataResponse> {
        const params = new HttpParams().set(
            'bPayBalanceDue',
            bPayBalanceDue.toString(),
        );
    ...
    ): Observable<RegisterTeamResponse> {
        return this.http.post<RegisterTeamResponse>(
            `${this.apiUrl}/register-team`,
            request,
        );
    }
    ...
    acceptRefundPolicy(): Observable<{ message: string }> {
        return this.http.post<{ message: string }>(
            `${this.apiUrl}/accept-refund-policy`,
            {},
        );
    }
    ...
    getConfirmationText(registrationId: string): Observable<string> {
        ...
        return this.http.post(`${this.apiUrl}/confirmation-text`, request, {
            responseType: 'text',
        });
    }
