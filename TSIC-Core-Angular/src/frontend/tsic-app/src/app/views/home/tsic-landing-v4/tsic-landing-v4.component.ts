...
@Component({
  selector: 'app-tsic-landing-v4',
  standalone: true,
  imports: [RouterLink],
  templateUrl: './tsic-landing-v4.component.html',
  styleUrl: './tsic-landing-v4.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class TsicLandingV4Component implements OnDestroy {
