...
@Component({
    selector: 'app-rw-constraint-selection',
    standalone: true,
    imports: [CommonModule],
    template: `
    <div class="card shadow border-0 card-rounded">
      <div class="card-header card-header-subtle border-0 py-3">
        <h5 class="mb-0 fw-semibold">Select Constraint</h5>
      </div>
      <div class="card-body">
        <p class="text-secondary mb-3">Choose the constraint value (e.g., Graduation Year) to filter available teams.</p>
