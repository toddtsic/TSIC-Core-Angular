...
public partial class JobMenuItem
{
    ...
    public virtual JobMenu? Menu { get; set; }

    public virtual ReportExportType? ReportExportType { get; set; }

    public virtual Report? ReportNameNavigation { get; set; }
}
