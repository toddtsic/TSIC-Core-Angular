...
public partial class RegFormField
{
    ...
    public virtual RegForm RegForm { get; set; } = null!;

    public virtual ICollection<RegFormFieldOption> RegFormFieldOptions { get; set; } = new List<RegFormFieldOption>();

    public virtual RegFormFieldType RegFormFieldType { get; set; } = null!;
}
