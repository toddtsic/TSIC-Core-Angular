    ...
    public async Task<AdultRegJobData?> GetJobAdultRegDataAsync(Guid jobId, CancellationToken cancellationToken = default)
    {
        return await _context.Jobs
            ...
            .Select(j => new AdultRegJobData
            {
                ...
                BRegistrationAllowStaff = j.BRegistrationAllowStaff ?? false,
                BRegistrationAllowReferee = j.BRegistrationAllowReferee ?? false,
                BRegistrationAllowRecruiter = j.BRegistrationAllowRecruiter ?? false,
