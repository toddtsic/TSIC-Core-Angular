...
/// <summary>
/// A registrant the notifier deliberately did NOT email, and why. Every skip is reported: a family
/// that cannot be reached is the one case a human has to pick up, so it must never be silent. See
/// the unresolved-token guard in ArbNotificationService.
/// </summary>
