...
public interface ITeamChatRepository
{
    ...
    /// <summary>
    /// One page of catch-up, ascending by LastTouchSeq, starting strictly after
    /// <paramref name="since"/>. Ordered by LastTouchSeq and NOT by Seq: an edit to an old
    /// message has to come back on the next poll.
    ///
...
/// <summary>A page of rows plus whether the thread holds more past the last one.</summary>
