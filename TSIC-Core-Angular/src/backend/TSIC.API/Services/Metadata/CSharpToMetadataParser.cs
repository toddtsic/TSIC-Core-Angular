...
public class CSharpToMetadataParser : ICSharpToMetadataParser
{
    ...
    private static string? InferDataSource(string propertyName)
    {
        return propertyName switch
        {
            ...
            "Reversible" or "ReversibleSize" => "ListSizes_Reversible",
            "Shoes" or "ShoesSize" => "ListSizes_Shoes",
            "ShortsSize" => "ListSizes_Shorts",
            "Sweatshirt" or "SweatshirtSize" => "ListSizes_Sweatshirt",
            "TShirt" or "TshirtSize" => "ListSizes_Tshirt",
