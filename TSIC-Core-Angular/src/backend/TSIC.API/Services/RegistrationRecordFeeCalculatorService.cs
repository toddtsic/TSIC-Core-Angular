...
/// </summary>
public class RegistrationRecordFeeCalculatorService : IRegistrationRecordFeeCalculatorService
{
    private readonly decimal _ccPercent;

    public RegistrationRecordFeeCalculatorService(IConfiguration config)
    {
